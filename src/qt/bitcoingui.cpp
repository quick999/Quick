    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Quick Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Quick address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and quick: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Quick Core"), this);
    aboutAction->setStatusTip(tr("Show information about Quick Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Quick Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Quick addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Quick addresses"));
    ...
    openAction->setStatusTip(tr("Open a quick: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Quick Core help message to get a list with possible Quick Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Quick Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Quick network", "", count));
}
...
{
    QString strTitle = tr("Quick Core"); // default title
