    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("Q-light"), QVariant("light"));
    ui->theme->addItem(QString("Q-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("Q-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("Q-traditional"), QVariant("trad"));
