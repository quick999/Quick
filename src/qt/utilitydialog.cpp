    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Quick Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Quick Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  quick-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Quick in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 Q, 0.1 Q, 1 Q and 10 Q -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://quickpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://quickpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Quick Core is shutting down...") + "<br /><br />" +
