...
{
    if(fLiteMode) return; // ignore all Quick related functionality
...
/*
    ...
    allow endless transaction that would bloat Quick and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("quick-privatesend");
