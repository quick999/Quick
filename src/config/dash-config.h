/* src/config/quick-config.h.  Generated from quick-config.h.in by configure.  */
/* src/config/quick-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/quickpay/quick/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Quick Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Quick Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "quickcore"
