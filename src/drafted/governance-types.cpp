...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "QuickNetwork") type = QuickNetwork;
    if(strType == "QuickNetworkVariable") type = QuickNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == QuickNetwork) s = "QuickNetwork";
    if(type == QuickNetworkVariable) s = "QuickNetworkVariable";
