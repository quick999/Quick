 ...
 *
 *   // network
 *   CQuickNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.quick.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CQuickNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: QuickNetwork
// //   -- signature requirements : Key1(User)
// class CQuickNetworkVariable : public CGovernanceObject
// {
// private:
