...
This mechanism has been integrated into Bitcore-Node-Quick which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/quickpay/insight-api-quick#web-socket-api](https://github.com/quickpay/insight-api-quick#web-socket-api) 
* API: [https://github.com/quickpay/insight-api-quick#instantsend-transactions](https://github.com/quickpay/insight-api-quick#instantsend-transactions) 
...
By default, the Quick Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Quick Core daemon:
