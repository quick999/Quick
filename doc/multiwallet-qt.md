...
Only requiring some minor changes is quick.cpp.
...
Changes to quick.cpp
----------------------
quick.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
